...
class ExceptionControllerAdvice {
    ...
    fun handleMethodArgumentTypeMismatchError(ex: Exception): ResponseEntity<ErrorMessageModel> {
        logger.error("MethodArgumentTypeMismatchException : ${ex.message}", ex)
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ErrorMessageModel(message = ex.message, status = HttpStatus.BAD_REQUEST.value()))
    }
